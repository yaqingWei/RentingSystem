...
<HEAD>
    ...
    <script language="javascript">
        ...
        function dataHuixie(){
            $("[name='telephone']").val("${fwxx.telephone}");
            $("[name='fileupload']").text("${fwxx.img}");
           $("[name='title']").val("${fwxx.title}");
            $("[name='qxid']").val("${fwxx.tbl_qx.qx}");
            $("[name='jdid']").val("${fwxx.tbl_jd.jd}");
            $("[name='zj']").val("${fwxx.zj}");
            $("[name='shi']").val("${fwxx.shi}");
            $("[name='ting']").val("${fwxx.ting}");
            $("[name='lxid']").val("${fwxx.tbl_fwlx.fwlx}");
            $("[name='lxr']").val("${fwxx.lxr}");
            $("[name='fwxx']").val("${fwxx.fwxx}")
        }
        ...
        function validateTitle() {
            ...
            if ($("[name='telephone']").val() == "" || isNaN($("[name='telephone']").val()) || !/\d{11}/.test($("[name='telephone']").val())) {
                alert("联系电话必须是11位数字")
                pass = false;
            }
            if ($("[name='fileupload']").val() == "") {
                alert("请上传房屋图片");
                pass = false;
            }
            return pass;
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td width="495">
            ...
            <form action="${pageContext.request.contextPath}/putFwxx" method="post" name="mf" onsubmit="return validateTitle()">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <c:forEach begin="1" end="${ting}" step="1" var="i">
                                <option value="${i}">${i}</option>
                            </c:forEach>
                        </select>厅
                        </td>
                    ...
                    <tr>
                        ...
                        <td><select name="lxid">
                            <c:forEach items="${fwlxList}" var="i">
                                <option value="${i.lxid}">${i.fwlx}</option>
                            </c:forEach>
                        </select></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <input type="hidden" name="fwid" value="${fwxx.fwid}">
